...
let furniture = [4, 5, 2];                                                           // Here furniture = ["chair", "table", "cot"].All values in units
if (furniture && furniture.length){
    ...
    console.log("Please Enter values in furniture array");
}
...
let name = [" Sad ", "Zahid", "Ayyan", "Tina", "Easha" ];
if (name && name.length){
    ...
    console.log("Please enter valus in name array.");
}